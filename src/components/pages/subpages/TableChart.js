            ...
            <form name="myForm">
                <TableContainer style={{display:'flex',justifyContent:'center'}}>
                    <Table style={{width:'50%',justifyContent:'center'}} size="small">
                        <TableHead>
                            <TableRow>
                                <TableCell><TextField value={subData['sub']} onChange={(e)=>setSubrData({...subData, "sub" : e.target.value})} label="Empolyee Name" margin="normal" variant="outlined" color="secondary"/></TableCell>
                                ...
                                <TableCell><Button variant="contained" onClick={()=>submitData(subData)} color="primary">Add Empolyee </Button></TableCell>
                            </TableRow>
                        </TableHead>
                        <TableBody>
                            {finalData.map(data =>(
